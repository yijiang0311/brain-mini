...
export default class Player extends Sprite {
  ...
  setPositionUp(App) {
    // if (this.y < screenHeight / 3 && App.bg.top < screenHeight+this.speed) {
    //   App.bg.updateUp(this.speed)
    // } else {
    //   this.setPosition(this.x, this.y - this.speed)
    // }
    console.log(App.bg.top,screenHeight,this.y,screenHeight*2/3)
  ...
  setPositionRight(App) {
    console.log(App.bg.left,screenWidth)
    console.log(this.x,screenWidth * 2 / 3)
    if (this.x > screenWidth*3/5 && App.bg.left > -screenWidth) {
